      ...
      (function(_React$PureComponent) {
        ...
        function C(p) {
          ...
          _this = _possibleConstructorReturn(
            this,
            _getPrototypeOf(C).call(this, p)
          );
          _this.initContainerRef = _this.initContainerRef.bind(
            _assertThisInitialized(_assertThisInitialized(_this))
          );
          _this.getContainerRef = _this.getContainerRef.bind(
            _assertThisInitialized(_assertThisInitialized(_this))
          );
          return _this;
        }
                  ...
                  options.map(function(_ref, key) {
                    var value = _ref[valueKey],
                      ...
                      rest = _objectWithoutProperties(
                        _ref,
                        [valueKey, labelKey].map(_toPropertyKey)
                      );
