...
function createComponent(AntdComponent, mapProps) {
    ...
    (function(_PureComponent) {
      ...
      function InputComponent(p) {
        ...
        _this = _possibleConstructorReturn(
          this,
          _getPrototypeOf(InputComponent).call(this, p)
        );
        _this.state = {
          componentRef: _assertThisInitialized(_assertThisInitialized(_this))
        };
        return _this;
      }
        ...
        },
        {
          ...
          value: function render() {
            var _mapProps = mapProps(this.props),
              ...
              hasFeedback =
                _mapProps$hasFeedback === void 0 ? true : _mapProps$hasFeedback,
              colon = _mapProps.colon,
              required = _mapProps.required,
              rest = _objectWithoutProperties(_mapProps, [
                'label',
                'labelCol',
                'wrapperCol',
                'help',
  ...
  InputComponent.displayName = 'Redux-form-ANTD'.concat(
    AntdComponent.displayName
  );
  return InputComponent;
}
